...
func RegisterRoutes(group *gin.RouterGroup) {
	...
	handlers = map[string]resourceHandler{
		...
		"advancedstatefulsets":     NewGenericResourceHandler[*kruiseappsv1beta1.StatefulSet, *kruiseappsv1beta1.StatefulSetList]("statefulsets", false, false),
		"advanceddaemonsets":       NewGenericResourceHandler[*kruiseappsv1alpha1.DaemonSet, *kruiseappsv1alpha1.DaemonSetList]("daemonsets", false, true),
		...
		"containerrecreaterequest": NewGenericResourceHandler[*kruiseappsv1alpha1.ContainerRecreateRequest, *kruiseappsv1alpha1.ContainerRecreateRequestList]("containerrecreaterequests", false, false),
